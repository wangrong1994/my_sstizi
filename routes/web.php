...
//支付宝支付
Route::post('alipay/create', 'AlipayController@createOrder'); // 创建订单及支付URL
Route::post('alipay/notify', 'AlipayController@notify'); // 异步回调

//使用教程
Route::any("shadowsocks/android","ShadowsocksController@android"); // 安卓教程页面
Route::any("shadowsocks/ios","ShadowsocksController@ios"); // IOS教程页面
Route::any("shadowsocks/mac","ShadowsocksController@mac"); // MAC教程页面
Route::any("shadowsocks/windows","ShadowsocksController@windows"); // WINDOW教程页面

//信用卡支付
Route::any('stripe/create', 'StripeController@create'); // 创建订单及支付URL
...
Route::group(['middleware' => ['user', 'admin']], function() {
  ...
  Route::any('admin/editGroup', 'AdminController@editGroup'); // 编辑级别
  Route::post('admin/delGroup', 'AdminController@delGroup'); // 删除级别
  ...
  Route::any("admin/test", "AdminController@test");
});
...
Route::group(['middleware' => ['user']], function() {
  ...
  Route::get('user/account', 'UserController@account'); // 节点账号
  ...
  Route::any("shadowsocks/user_android","ShadowsocksController@user_android"); // 安卓教程页面
  Route::any("shadowsocks/user_ios","ShadowsocksController@user_ios"); // IOS教程页面
  Route::any("shadowsocks/user_mac","ShadowsocksController@user_mac"); // MAC教程页面
  Route::any("shadowsocks/user_windows","ShadowsocksController@user_windows"); // WINDOW教程页面
  Route::post('user/modify_passwd', 'UserController@modify_passwd'); // 用户自行修改账户密码
});
