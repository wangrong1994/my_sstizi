...
<!-- BEGIN HEADER -->
<div class="page-header navbar navbar-fixed-top" id="sstnavBj">
    <!-- BEGIN HEADER INNER -->
    @if (Session::has('errorMsg'))
     ...
     @endif
    <div class="page-header-inner " style="max-width:1500px;margin-left:auto;margin-right:auto;">
       <!-- BEGIN LOGO -->
        <div class="page-logo">
            <a href="{{url('/user')}}">
                <img src="/assets/images/logo.png" alt="logo" class="logo-default" style="margin-left:25px;"/> </a>
            <div class="menu-toggler sidebar-toggler" style="margin-right:75px;">
            ...
            <div class="top-menu">
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown dropdown-user dropdown-dark">
                        <a href="javascript:;" class="dropdown-toggle" id="sstdrop_tit" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                            <span class="username username-hide-on-mobile" style="color:white;"> {{Session::get('user')['username']}} </span>
                            <!-- DOC: Do not remove below empty space(&nbsp;) as its purposely used -->
                            <img alt="" class="img-circle" src="/assets/images/avatar.png" /> </a>
                        <ul class="dropdown-menu dropdown-menu-default" style="background:#28376e;">
...
<!-- BEGIN CONTAINER -->
<div class="page-container" style="max-width:1500px;margin-left:auto;margin-right:auto;">
    <!-- BEGIN SIDEBAR -->
    <div class="page-sidebar-wrapper">
        ...
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                ...
                <li class="nav-item {{in_array(Request::path(), ['user/account']) ? 'active open' : ''}}">
                    <a href="{{url('user/account')}}" class="nav-link nav-toggle">
                        <i class="icon-list"></i>
                        <span class="title">{{trans('home.account')}}</span>
                    </a>
                </li>
...
<!-- END CONTAINER -->
<!-- BEGIN FOOTER -->
<div class="page-footer lxwm" style="max-width:1500px;margin-left:auto;margin-right:auto;">
    <div class="page-footer-inner" style="position:fixed;bottom:0px;"> <h4 style="color:#797c83;margin-bottom:5px;">联系我们</h4><p style="margin-bottom:0;color:#797c83;margin-top:10px;font-szie:14px;">邮箱 <a href="mailto:sstizi.au@gmail.com" style="color:#797c83;">sstizi.au@gmail.com</a></p> </div>
