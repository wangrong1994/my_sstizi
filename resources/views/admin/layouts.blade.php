...
<!-- BEGIN HEADER -->
<div class="page-header navbar navbar-fixed-top" id="sstadnavBj">
    <!-- BEGIN HEADER INNER -->
            ...
            <div class="top-menu">
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown dropdown-user dropdown-dark">
                        <a href="javascript:;" class="dropdown-toggle" id="sstaddrop_tit" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
