                                ...
                                <tbody>
                                    ...
                                    @else
                                        @foreach ($userList as $user)
                                            ...
                                            <td>
                                                @if ($user->level <0) 
                                                    <span class="label label-danger">无等级</span>
                                                @elseif ($user->level == 1)
                                                    <span>试用会员</span>
                                                @elseif ($user->level == 2)
                                                    <span class="label label-default">普通会员</span>
                                                @elseif ($user->level == 3)
                                                    <span class="label label-info">专业会员</span>
                                                @elseif ($user->level == 4)
                                                    <span class="label label-warning">尊享会员</span>
                                                @endif
                                            </td>
                                            ...
                                            <td class="center">
                                                ...
                                                @else
                                                    {{(strtotime($user->expire_time) != strtotime('2099-01-01 00:00:00')) ? $user->expire_time : '未购买'}}
                                                @endif
                                            </td>
                                            <td>
                                                @if ($user->status == '1')
