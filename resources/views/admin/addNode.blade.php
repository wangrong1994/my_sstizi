                                            ...
                                            <div class="portlet light bordered">
                                                ...
                                                <div class="portlet-body">
                                                    <div class="form-group">
                                                        <label for="name" class="col-md-3 control-label"><span style="color:red"> * </span> 节点名称 </label>
                                                        <div class="col-md-8">
                                                            <input type="text" class="form-control" name="name" id="name" placeholder="" autofocus required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="server" class="col-md-3 control-label"><span style="color:red"> * </span> 服务器地址 </label>
                                                        <div class="col-md-8">
                                                            <input type="text" class="form-control" name="server" id="server" placeholder="域名或IP地址" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="group_id" class="col-md-3 control-label"><span style="color:red"> * </span> 所属分组 </label>
                                                        <div class="col-md-8">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="country_code" class="col-md-3 control-label"><span style="color:red"> * </span> 国家/地区 </label>
                                                        <div class="col-md-8">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="portlet light bordered">
                                                ...
                                                <div class="portlet-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="method" class="col-md-3 control-label"><span style="color:red"> * </span>加密方式</label>
                                                        <div class="col-md-8">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="protocol" class="col-md-3 control-label"><span style="color:red"> * </span>协议</label>
                                                        <div class="col-md-8">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="obfs" class="col-md-3 control-label"><span style="color:red"> * </span>混淆</label>
                                                        <div class="col-md-8">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="traffic" class="col-md-3 control-label"><span style="color:red"> * </span>每月可用流量</label>
                                                        <div class="col-md-8">
                                                            <div class="input-group">
                                                                <input type="text" class="form-control right" name="traffic" value="10000" id="traffic" placeholder="" required>
