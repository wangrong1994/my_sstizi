...
<head>
    <meta charset="UTF-8">
    <title>shadowsocks使用教程---iOS</title>
...
<body>
    <div class="ssHeader">
        <div class="cont">
            ...
            @endif
    <div class="cont">
        <h1>shadowsocks使用教程---iOS</h1>
        <section>
            <h3>第一步：下载客户端APP</h3>
            <p>
                打开手机微信扫描下方二维码，即可跳转至 App Store 进行下载。
            </p>
            <img src="/assets/images/ios/ios01.png" style="width: 30%;height: auto" />
        </section>
        <section>
            ...
            <img src="/assets/images/ios/ios02.png" style="width: 80%;height: auto" />
        </section>
        <section>
            <h3>第三步：打开手机App配置线路</h3>
            <p>
                打开刚才安装的app，如图依次点击，扫描配置信息二维码，扫码成功后选择线路，然后点击连接按钮即可连接。
            </p>
            <img src="/assets/images/ios/ios03.png" style="width: 45%;height: auto" />
            <img src="/assets/images/ios/ios04.png" style="width: 45%;height: auto" />
            <p>
                首次连接要安装证书，需验证指纹或手机解锁密码，这里可以放心验证，无任何安全隐患。
            </p>
            <img src="/assets/images/ios/ios05.png" style="width: 45%;height: auto" />
            <img src="/assets/images/ios/ios06.png" style="width: 45%;height: auto" />
            <p>
            ...
            <img src="/assets/images/ios/ios07.png" style="width: 45%;height: auto" />
            <img src="/assets/images/ios/ios08.png" style="width: 45%;height: auto" />
        </section>
