...
-- ----------------------------
-- Table structure for `ss_node` 节点表
-- ----------------------------
...
-- ----------------------------
-- Table structure for `ss_node_info` 节点详情表
-- ----------------------------
...
-- ----------------------------
-- Table structure for `ss_group`  节点分组表
-- ----------------------------
...
-- ----------------------------
-- Table structure for `ss_group_node`  分组节点关系表
-- ----------------------------
...
-- ----------------------------
-- Table structure for `ss_config` 节点配置表
-- ----------------------------
...
-- ----------------------------
-- Table structure for `ss_node_online_log` 节点在线记录表
-- ----------------------------
...
CREATE TABLE `user` (
  ...
  `enable` tinyint(4) NOT NULL DEFAULT '1' COMMENT 'SS状态 0-禁用，1-启用',
  ...
  `level` tinyint(4) NOT NULL DEFAULT '1' COMMENT '等级：可定义名称1-普通会员，2-专业会员，3-尊享会员',
...
alter table user add column   `user_type` tinyint(2) NOT NULL DEFAULT 1 COMMENT '用户购买后类型：1-包月用户，2-包年用户';
...
-- Records of `level`
-- ----------------------------
INSERT INTO `level` VALUES (4, '0', '试用会员', '2017-10-26 15:41:31', '2017-10-26 15:41:31');
INSERT INTO `level` VALUES (1, '1', '普通会员', '2017-10-26 15:56:52', '2017-10-26 15:38:58');
INSERT INTO `level` VALUES (2, '2', '专业会员', '2017-10-26 15:57:30', '2017-10-26 12:37:51');
INSERT INTO `level` VALUES (3, '3', '尊享会员', '2017-10-26 15:41:31', '2017-10-26 15:41:31');


-- ----------------------------
-- Table structure for `user_traffic_log` 用户流量记录表
-- ----------------------------
...
INSERT INTO `config` VALUES ('9', 'website_url', 'http://www.ssrpanel3.com');
...
CREATE TABLE `goods` (
  ...
  `name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '商品类型：普通套餐/专业套餐/尊享套餐',
  ...
  `score` int(11) NOT NULL DEFAULT '0' COMMENT '商品年付价值多少积分',
  `type` tinyint(4) NOT NULL DEFAULT '1' COMMENT '商品类型：1-流量包、2-套餐',
  `year_price` int(11) NOT NULL DEFAULT '0' COMMENT '商品年付单价，单位分/月',
  `mon_price` int(11) NOT NULL DEFAULT '0' COMMENT '商品年付单价，单位分/月',
...
alter table goods add column  `year_price` int(11) NOT NULL DEFAULT '0' COMMENT '商品年付单价，单位分/月';
alter table goods add column   `mon_price` int(11) NOT NULL DEFAULT '0' COMMENT '商品年付单价，单位分/月';
alter table goods modify created_at datetime not null default CURRENT_TIME ;
alter table goods add column `level` tinyint(3) NOT NULL DEFAULT '1' COMMENT '所属分组';
alter table goods modify  `logo` varchar(255) COLLATE utf8mb4_unicode_ci  NULL DEFAULT '' COMMENT '商品图片地址',

-- ----------------------------
-- Table structure for `coupon` 优惠券
-- ----------------------------
CREATE TABLE `coupon` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for `order` 订单信息表
-- ----------------------------
CREATE TABLE `order` (
  ...
  `pay_way` tinyint(4) NOT NULL DEFAULT '1' COMMENT '支付方式：1-支付宝、2-信用卡',
  `status` tinyint(4) NOT NULL DEFAULT '0' COMMENT '订单状态：-0-待支付、1-已支付待确认、2-已完成',
  `created_at` datetime DEFAULT NULL COMMENT '创建时间',
...
alter table `order` add column `goods_method` tinyint(2) NOT NULL DEFAULT '0' COMMENT '套餐类型，0-包月 1-包年';
alter table `order` drop column totalOriginalPrice;
...
-- ----------------------------
-- Table structure for `ticket` 工单表
-- ----------------------------
CREATE TABLE `ticket` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for `user_score_log` 用户积分记录表
-- ----------------------------
...
-- ----------------------------
-- Table structure for `article` 文章/公告表
-- ----------------------------
...
-- ----------------------------
-- Table structure for `article_log`  文章记录表
-- ----------------------------
...
-- ----------------------------
-- Table structure for `invite` 邀请表
-- ----------------------------
CREATE TABLE `invite` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for `verify`  验证表
-- ----------------------------
CREATE TABLE `verify` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
